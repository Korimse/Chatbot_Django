...
import re
def get_xml(stop_id):
    url = 'http://openapi.tago.go.kr/openapi/service/ArvlInfoInqireService/getSttnAcctoArvlPrearngeInfoList?serviceKey=UO%2Ff1JIdATORyBZlMoob7p9jA%2F8qPAuEPC%2BLahj%2FcG%2BvOTVAw%2FQ5bs1CstZmYU0cpLYNG75IKVMrI%2FM3u1V8yQ%3D%3D&cityCode=34040&nodeId=ASB'
    url = url + str(stop_id)
