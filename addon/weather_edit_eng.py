...
def weather():
    try :
        return weather_parshing('5020f2a1f0cfc2399d0f26f4bd0bc688')

    except:
        return weather_parshing('e9db8652e9682ee2df2ea0422460578e')

def air_status():
    import urllib.request
    from bs4 import BeautifulSoup
    url = 'http://openapi.airkorea.or.kr/openapi/services/rest/ArpltnInforInqireSvc/getCtprvnRltmMesureDnsty?serviceKey=UO%2Ff1JIdATORyBZlMoob7p9jA%2F8qPAuEPC%2BLahj%2FcG%2BvOTVAw%2FQ5bs1CstZmYU0cpLYNG75IKVMrI%2FM3u1V8yQ%3D%3D&numOfRows=999&pageSize=999&pageNo=1&startPage=1&sidoName=%EC%B6%A9%EB%82%A8&ver=1.3'
